...
.banner img{{display:block;width:100%;height:420px;object-fit:cover;object-position:center 30%}}
...
@media (max-width:600px){{.banner img{{height:220px}} .banner-text h1{{font-size:28px}}}}
</style></head><body>
<header class="banner">
